...
- Keep the mobile and tablet sidebar closed by default by giving the responsive
  closed-state rule higher specificity than the later base sidebar rule.
- Add a regression contract for the responsive CSS import order, closed state,
  and checked open state.
